...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, accessToken: $accessToken, name: $name, login: $login, password: $password, phone: $phone, role: $role, avatar: $avatar, status: $status, warehouseName: $warehouseName, warehouseId: $warehouseId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, accessToken, name, login,
      password, phone, role, avatar, status, warehouseName, warehouseId);
...
abstract class _User implements User {
  const factory _User(
      ...
      @JsonKey(name: 'warehouse_id') final String? warehouseId}) = _$UserImpl;
