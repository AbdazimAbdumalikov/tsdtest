...
/// @nodoc
abstract class _$$WarehouseOrderDTOImplCopyWith<$Res>
    implements $WarehouseOrderDTOCopyWith<$Res> {
  factory _$$WarehouseOrderDTOImplCopyWith(_$WarehouseOrderDTOImpl value,
          $Res Function(_$WarehouseOrderDTOImpl) then) =
      __$$WarehouseOrderDTOImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$WarehouseOrderDTOImplCopyWithImpl<$Res>
    extends _$WarehouseOrderDTOCopyWithImpl<$Res, _$WarehouseOrderDTOImpl>
    implements _$$WarehouseOrderDTOImplCopyWith<$Res> {
  __$$WarehouseOrderDTOImplCopyWithImpl(_$WarehouseOrderDTOImpl _value,
      $Res Function(_$WarehouseOrderDTOImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WarehouseOrderDTOImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$WarehouseOrderDTOImpl implements _WarehouseOrderDTO {
  const _$WarehouseOrderDTOImpl(
      {required this.id,
      this.status,
      this.number,
  ...
  factory _$WarehouseOrderDTOImpl.fromJson(Map<String, dynamic> json) =>
      _$$WarehouseOrderDTOImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$WarehouseOrderDTOImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WarehouseOrderDTOImplCopyWith<_$WarehouseOrderDTOImpl> get copyWith =>
      __$$WarehouseOrderDTOImplCopyWithImpl<_$WarehouseOrderDTOImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WarehouseOrderDTOImplToJson(
      this,
    );
  }
}
...
abstract class _WarehouseOrderDTO implements WarehouseOrderDTO {
  const factory _WarehouseOrderDTO(
      ...
      final String? provider,
      final CounteragentDTO? counteragent}) = _$WarehouseOrderDTOImpl;

  factory _WarehouseOrderDTO.fromJson(Map<String, dynamic> json) =
      _$WarehouseOrderDTOImpl.fromJson;
