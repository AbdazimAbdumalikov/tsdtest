...
/// @nodoc
abstract class _$$RefundDataDTOImplCopyWith<$Res>
    implements $RefundDataDTOCopyWith<$Res> {
  factory _$$RefundDataDTOImplCopyWith(
          _$RefundDataDTOImpl value, $Res Function(_$RefundDataDTOImpl) then) =
      __$$RefundDataDTOImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$RefundDataDTOImplCopyWithImpl<$Res>
    extends _$RefundDataDTOCopyWithImpl<$Res, _$RefundDataDTOImpl>
    implements _$$RefundDataDTOImplCopyWith<$Res> {
  __$$RefundDataDTOImplCopyWithImpl(
      _$RefundDataDTOImpl _value, $Res Function(_$RefundDataDTOImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RefundDataDTOImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$RefundDataDTOImpl implements _RefundDataDTO {
  const _$RefundDataDTOImpl(
      {required this.id,
  ...
  factory _$RefundDataDTOImpl.fromJson(Map<String, dynamic> json) =>
      _$$RefundDataDTOImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RefundDataDTOImplCopyWith<_$RefundDataDTOImpl> get copyWith =>
      __$$RefundDataDTOImplCopyWithImpl<_$RefundDataDTOImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RefundDataDTOImplToJson(
      this,
    );
  }
}
...
abstract class _RefundDataDTO implements RefundDataDTO {
  const factory _RefundDataDTO(
      ...
      final int? status}) = _$RefundDataDTOImpl;

  factory _RefundDataDTO.fromJson(Map<String, dynamic> json) =
      _$RefundDataDTOImpl.fromJson;
