...
class __$$LoadedStateImplCopyWithImpl<$Res>
    extends _$SignInStateCopyWithImpl<$Res, _$LoadedStateImpl>
...
class _$LoadedStateImpl implements _LoadedState {
  const _$LoadedStateImpl({required this.user});
...
abstract class _LoadedState implements SignInState {
  const factory _LoadedState({required final User user}) = _$LoadedStateImpl;
