...
class OrderDetailEventInitial extends OrderDetailEvent {
  ...
  OrderDetailEventInitial(this.orderId, this.userId);
}
...
class OrderDetailEventStop extends OrderDetailEvent {
  ...
  OrderDetailEventStop(
      {required this.pointId, required this.cause, this.emptyDriver});
}
...
class OrderDetailSignEvent extends OrderDetailEvent {
  final int orderId;
...
class OrderWmsDocumentsInitialEvent extends OrderDetailEvent {
  final int orderId;

  OrderWmsDocumentsInitialEvent({required this.orderId});
}
