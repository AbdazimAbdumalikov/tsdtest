        ...
        return GestureDetector(
          onTap: () {
            ...
            if (order.orderType == 1) {
              if (isRightPoint(
                  points: nonNullPoints, point: point!, order: order)) {
                ...
                showCustomSnackbar(
                    context, 'Сначала закончите предыдущие точки');
              }
            }
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (pointName.contains(query) ||
                    ...
                    return InkWell(
                      onLongPress: () {
                        List<PointDTO> point = List.from(widget.order.points!);
                        _showPopupMenu(
                            context, getLastPointId, widget.order.id);
                      },
...
void _showPopupMenu(BuildContext context, pointId, orderId) {
