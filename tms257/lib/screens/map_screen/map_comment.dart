...
//     //Преобразовать eta в DateTime и отсортировать точки
//     data.sort((a, b) {
...
//     });
//
//     //Построить маршрут по отсортированным точкам
...
//         final String pointNumber = (i).toString();
//
//         placemarks.add(
//             PlacemarkMapObject(
...
//                 // Можете добавить здесь код для отображения информации о метке или других действий
//                 print('Метка была нажата! Latitude: ${point.latitude}, Longitude: ${point.longitude}, Point ID: $pointId,');
//                 print('onTap вызвано!');
