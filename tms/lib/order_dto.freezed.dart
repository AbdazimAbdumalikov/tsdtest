...
class _$_OrderStatusDTO implements _OrderStatusDTO {
  ...
  @override
  String toString() {
    return 'OrderStatusDTO(id: $id, orderId: $orderId, status: $status, stopReason: $stopReason, stopTimer: $stopTimer, order: $order, orderStatus: $orderStatus, orderType: $orderType)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, orderId, status, stopReason,
      stopTimer, order, orderStatus, orderType);
...
abstract class _OrderStatusDTO implements OrderStatusDTO {
  const factory _OrderStatusDTO(
      ...
      @JsonKey(name: 'order_type') final int? orderType}) = _$_OrderStatusDTO;
